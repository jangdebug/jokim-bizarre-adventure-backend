...
public enum BaseResponseStatus {
    ...
    ALREADY_EXIST_CATEGORY(HttpStatus.CONFLICT, false, 2402, "이미 존재하는 카테고리명입니다."),
    FAILED_TO_GENERATE_CATEGORY_CODE(HttpStatus.CONFLICT, false, 2403, "고유한 카테고리 코드를 생성하는 데 실패했습니다."),
    FAILED_TO_INSERT_CATEGORY(HttpStatus.CONFLICT, false, 2404, "카테고리 생성 중 오류가 발생했습니다."),
    FAILED_TO_UPDATE_CATEGORY(HttpStatus.CONFLICT, false, 2405, "카테고리 업데이트 중 오류가 발생했습니다."),
